...
from spynnaker.pyNN.models.neuron.neuron_models.abstract_neuron_model import AbstractNeuronModel
...
class NeuronModelZeroLeakIntegrateAndFire(AbstractNeuronModel):
    __slots__ = [
        "__v_init",
        "__v_rest",
        "__cm",
    ...
    def __init__(
            self, v_init, v_rest, cm, i_offset, v_reset, tau_refrac):
        super(NeuronModelZeroLeakIntegrateAndFire, self).__init__(
            [DataType.S1615,   # v
